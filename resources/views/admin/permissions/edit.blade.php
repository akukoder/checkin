@extends('layouts.app', ['title' => __('Edit Permission')])

@section('content')
    @include('partials.header', ['title' => 'Edit Permission', 'class' => 'col-12 col-md-6'])
                ...
                <div class="card bg-secondary shadow">
                    <div class="card-header bg-white border-0">
                        <div class="row align-items-center">
                            <div class="col-8">
                                <h3 class="mb-0">{{ __('Permission Information') }}</h3>
                            </div>
