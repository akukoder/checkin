@extends('layouts.app', ['title' => __('Edit Station')])

@section('content')
    @include('partials.header', ['title' => 'Edit Station', 'class' => 'col-12 col-md-6'])
        ...
        <div class="row justify-content-center">
            <div class="col-12 col-md-6">
                <div class="card bg-secondary shadow">
                    ...
                    <div class="card-body">
                        <form method="post" action="{{ route('station.update', $station) }}" autocomplete="off" enctype="multipart/form-data">
                            @csrf
                            @method('put')
                            ...
                            <div class="pl-lg-4">
                                ...
                                <div class="form-group row">
                                    <label class="form-control-label col-form-label col-12 col-md-3" for="input-logo">{{ __('Existing Logo') }}</label>

                                    <div class="col-4 col-md-3">
                                        <img src="{{ Storage::url($station->logo) }}" alt="{{ $station->name }}" class="img-fluid">
                                    </div>
                                </div>
